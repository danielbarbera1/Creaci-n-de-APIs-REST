...
NOTA
La base de datos de produccion ya tiene las nuevas tablas , solo falta poner en produccion el frontend con los cambios , aunque ya se hizo commit y push para este momento
